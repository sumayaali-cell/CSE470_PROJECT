        ...
        <>
          ...
          <div className="mt-8 flex w-full max-w-2xl relative">
            ...
            <button
              ...
              className="px-6 bg-black text-white font-semibold rounded-r-lg hover:bg-gray-900"
            >
              Search Items
            </button>
  ...
  <div className="absolute top-full left-0 w-full bg-white border border-gray-300 rounded-b-lg shadow-lg z-50">
    {searchResults.map((item) => {
      ...
      return (
        <Link
          key={item._id}
          to={`/text/${item.user}`} // keep your route here
        ...
        >
          ...
          <div>
            ...
            <span className="text-sm text-gray-500">{formattedDate}</span> {/* ✅ formatted local time */}
          </div>
        </Link>
      );
    })}
          ...
          <div className="mt-6 flex gap-4">
            ...
            <button
              onClick={() => navigate("/post")}
              className="flex items-center gap-2 px-6 py-3 bg-gray-200 text-gray-800 rounded-lg shadow hover:bg-gray-300"
            >
              Report Found Item
            </button>
          </div>
          ...
          <div className="mt-10 max-w-5xl grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-xl shadow-lg bg-blue-50 hover:scale-105 transition-transform duration-300 text-center">
              ...
              <p className="text-gray-600">
                Submit details of lost or found items easily through our
                platform.
              </p>
            </div>
            {/* Step 2 */}
            ...
            <div className="p-6 rounded-xl shadow-lg bg-yellow-50 hover:scale-105 transition-transform duration-300 text-center">
              ...
              <p className="text-gray-600">
                Successfully reunite lost items with their owners quickly and
                safely.
              </p>
            </div>
          </div>
